...
class SearchController extends StateNotifier<SearchState> {
  ...
  Future<void> search({
    ...
    try {
      ...
      final filteredResults = query == null || query.isEmpty
          ? results
          : results.where((pro) {
      ...
      // Optional distance sort when the user's position is available (Haversine).
      final sortedResults = userLocation != null
          ? _sortByDistance(filteredResults, userLocation)
          : filteredResults;
